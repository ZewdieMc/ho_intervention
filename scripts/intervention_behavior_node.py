...
class setGoal (py_trees.behaviour.Behaviour):
    ...
    def update(self):
        ...
        # else:
        #     self.blackboard.goal = self.base_goal
...
if __name__ == "__main__":
    ...
    go_to_seq.add_children([set_goal,move_base, move_down,enable_suction,move_up, move_place_box, place_box])
